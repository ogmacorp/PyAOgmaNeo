...
PYBIND11_MODULE(pyaogmaneo, m) {
    ...
    py::class_<pyaon::Hierarchy>(m, "Hierarchy")
        ...
        .def("setEMargin", &pyaon::Hierarchy::setEMargin)
        .def("getEMargin", &pyaon::Hierarchy::getEMargin)
        .def("setDLR", &pyaon::Hierarchy::setDLR)
        .def("getDLR", &pyaon::Hierarchy::getDLR)
        .def("setDMargin", &pyaon::Hierarchy::setDMargin)
        .def("getDMargin", &pyaon::Hierarchy::getDMargin)
