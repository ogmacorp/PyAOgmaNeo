...
PYBIND11_MODULE(pyaogmaneo, m) {
    ...
    py::class_<pyaon::Hierarchy>(m, "Hierarchy")
        ...
        .def("getGHiddenCIs", &pyaon::Hierarchy::getGHiddenCIs)
        .def("getEHiddenSize", &pyaon::Hierarchy::getEHiddenSize)
        .def("getGHiddenSize", &pyaon::Hierarchy::getGHiddenSize)
        ...
        .def("getNumDLayers", &pyaon::Hierarchy::getNumDLayers)
        .def("getNumGVisibleLayers", &pyaon::Hierarchy::getNumGVisibleLayers)
        .def("getIOSize", &pyaon::Hierarchy::getIOSize)
        .def("setELR0", &pyaon::Hierarchy::setELR0)
        .def("getELR0", &pyaon::Hierarchy::getELR0)
        //.def("setGLR0", &pyaon::Hierarchy::setGLR0)
        //.def("getGLR0", &pyaon::Hierarchy::getGLR0)
        .def("setDLR0", &pyaon::Hierarchy::setDLR0)
        .def("getDLR0", &pyaon::Hierarchy::getDLR0)
