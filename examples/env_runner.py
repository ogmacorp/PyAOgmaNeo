...
class EnvRunner:
    ...
    def __init__(self, env, layer_sizes=2 * [(5, 5, 16)],
        temporal_size=4, num_dendrites_per_cell=16, value_num_dendrites_per_cell=32,
        input_radius=4, layer_radius=2, hidden_size=(10, 10, 16),
        image_radius=8, image_scale=0.5, obs_resolution=32, action_resolution=9, action_importance=0.5,
        ...
        for i in range(len(layer_sizes)):
            ...
            ld.temporal_size = temporal_size
