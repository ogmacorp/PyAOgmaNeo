...
class EnvRunner:
    def __init__(self, env, layer_sizes=4 * [(5, 5, 64)],
        num_dendrites_per_cell=4, input_radius=10, layer_radius=2, hidden_size=(10, 10, 16),
        image_radius=8, image_scale=0.5, obs_resolution=8, action_resolution=9,
