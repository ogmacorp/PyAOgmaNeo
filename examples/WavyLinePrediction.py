...
def wave(t):
    return np.sin(t * 0.01 * 2.0 * np.pi - 0.5) * np.sin(t * 0.04 * 2.0 * np.pi + 0.5) * np.sin(t * 0.0025 * 2.0 * np.pi - 0.25)
...
for t2 in range(500):
    ...
    for i in range(len(units)):
        units[i].append(float(h.getHiddenCIs(0)[i]) / float(h.getHiddenSize(0)[2] - 1))
