...
class EnvRunner:
    def __init__(self, env, layerSizes=2 * [ (3, 3, 16) ], layerRadius=2, hiddenSize=(8, 8, 32), imageRadius=8, imageScale=1.0, obsResolution=32, actionResolution=16, rewardScale=1.0, terminalReward=0.0, infSensitivity=1.0, nThreads=8):
        self.env = env
