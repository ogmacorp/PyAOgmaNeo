...
class EnvRunner:
    def __init__(self, env, layerSizes=4 * [ (4, 4, 32) ], layerRadius=4, hiddenSize=(8, 8, 16), imageRadius=6, imageScale=1.0, obsResolution=32, actionResolution=16, rewardScale=1.0, terminalReward=0.0, infSensitivity=1.0, nThreads=8, loadName=None):
        self.env = env
